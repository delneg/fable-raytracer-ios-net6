...
strip ./target/x86_64-apple-ios/release/libcore.a
strip ./target/aarch64-apple-ios/release/libcore.a

# Create fat binary
libtool -static -o ./core/libcore ./target/aarch64-apple-ios/release/libcore.a ./target/x86_64-apple-ios/release/libcore.a
